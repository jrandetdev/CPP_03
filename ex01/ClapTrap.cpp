...
ClapTrap::ClapTrap(const ClapTrap& other)
{
	...
	std::cout <<  "ClapTrap:: Base class copy constructor called for" << other.name <<'\n';
}
...
ClapTrap::~ClapTrap()
{
	std::cout << "ClapTrap:: Base class default destructor called for object " << this->name << std::endl;
}
